 ...
 * @author v8002382
 */
public class AirportStaticRampTest {
    
    public AirportStaticRampTest() {
        
    }
    
    /**
     * Test of getSerialNumber method, of class AirportStaticRamp.
     */
    @Test
    public void testGetSerialNumber() {
        final AirportRamp ramp = new AirportStaticRamp("CRE23SCENT", "AIRCREST-12");
    ...
    public void testGetNullSerialNumber() {
        final AirportRamp ramp = new AirportStaticRamp(null, "AIRCREST-12");
        assertNull(ramp.getSerialNumber());
        System.out.println("Null Serial Number Getter test OK");
    }
    
    /**
     * Test of deploy method, of class AirportStaticRamp.
     */
    @Test
    public void testDeploy()
    {
        final AirportRamp ramp = new AirportStaticRamp("CRESCENT", "AIRCREST-12");
        assertEquals(ramp.deploy(), "Ramp deploying timer (5 seconds) started...");
        System.out.println("Dispatch test OK");
    }

    /**
     * Test of isAvailable method, of class AirportStaticRamp.
     */
    @Test
    ...
    /**
     * Test of getParkingBay method, of class AirportStaticRamp.
     */
    @Test
    ...
    public void testGetNullParkingBay() {
        final AirportRamp ramp = new AirportStaticRamp("CRE23SCENT", null);
        assertNull(ramp.getParkingBay());
        System.out.println("Null Parking Bay Getter test OK");
    }

    /**
     * Test of detach method, of class AirportStaticRamp.
     */
    @Test
